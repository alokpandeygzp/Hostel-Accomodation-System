...
<?php	
$aid=$_SESSION['login'];
	$ret="select * from registration,mess where (emailid=? || regno	=?) and mess.messName=registration.messName;";
...
<th>Hostel Name :</th>
<td colspan="3"><?php echo $row->hostelName;?> Hostel</td>
</tr>
