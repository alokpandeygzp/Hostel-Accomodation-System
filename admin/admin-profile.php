	...
	<div class="ts-main-content">
		...
		?>
			...
			<div class="page-content" style="margin-top: -185px; margin-bottom:-300px; margin-left: 100px;margin-right: 0px;padding:none; background-color:#00121ff7;">
				<div class="form-v9-content" style="height: 680px;width: 750px;margin-left: 4%;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);background-color: #111e2b;">
					<form class="form-detail" action="#" method="post">
						<center>
							<h1 style="margin-top:70px;">Admin Profile Details</h1>
						</center>
						<br><br><br>
